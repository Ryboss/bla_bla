...
from app.shemas.booking import BookingCreateSchema, BookingOutSchema
...
async def create_booking(
        trip_id: int, booking: BookingCreateSchema,
...
async def list_bookings(trip_id: int, db: AsyncSession = Depends(get_db), current_user=Depends(get_current_user)):
